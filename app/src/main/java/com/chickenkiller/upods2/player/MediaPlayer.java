...
public class MediaPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  public interface RendererBuilder {
     ...
     */
    void buildRenderers(MediaPlayer player, RendererBuilderCallback callback);
  }
  ...
  public interface RendererBuilderCallback {
     ...
     *     indexed by {@link MediaPlayer} TYPE_* constants. May be null if there are no types with
  ...
  private class InternalRendererBuilderCallback implements RendererBuilderCallback {
    ...
    public void onRenderers(String[][] trackNames, MultiTrackChunkSource[] multiTrackSources,
        TrackRenderer[] renderers, BandwidthMeter bandwidthMeter) {
      if (!canceled) {
        MediaPlayer.this.onRenderers(trackNames, multiTrackSources, renderers, bandwidthMeter);
      }
    }
    ...
    public void onRenderersError(Exception e) {
      if (!canceled) {
        MediaPlayer.this.onRenderersError(e);
      }
    }
